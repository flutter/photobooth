    ...
    group('sharePhoto', () {
      ...
      test('returns correct share urls', () async {
        ...
        expect(
          ...
          equals(
            'https://photobooth.flutter.dev/share/photo.jpg',
          ),
        );
        expect(
          shareUrls.facebookShareUrl,
          equals(
            'https://www.facebook.com/sharer.php?u=https://photobooth.flutter.dev/share/photo.jpg&quote=Share%20text',
          ),
        );
        expect(
          shareUrls.twitterShareUrl,
          equals(
            'https://twitter.com/intent/tweet?url=https://photobooth.flutter.dev/share/photo.jpg&text=Share%20text',
          ),
        );
      });
